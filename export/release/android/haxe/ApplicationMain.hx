...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ModsEngine063", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ModsEngine063", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "176";
		app.meta["company"] = "AliAlafandy";
		app.meta["file"] = "ModsEngine063";
		app.meta["name"] = "Friday Night Funkin': Mods Engine";
		app.meta["packageName"] = "com.alialafandy.modsengine063";
		app.meta["version"] = "5.0.0";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin': Mods Engine",
			width: 1280,
			x: null,
			y: null,
		};
